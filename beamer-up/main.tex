...
% Current checkout note: this demo still exercises the inherited \usetheme{UU} interface until the planned \usetheme{UP} migration lands.
...
% This file documents the present brownfield state and should not be read as the final public naming contract.
