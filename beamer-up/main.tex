...
% -- Metadata -----------------------------------
\title[UP Beamer Theme]{Beamer Theme for UP {\footnotesize \quad \textcolor{UPForestGreen}{v1.0.0}}}
\subtitle{\textbf{A \LaTeX\ presentation template for University of the Philippines System}}
...
\addinstitute{1}{DMPCS, CSM, University of the Philippines - Mindanao}
\addinstitute{2}{DCS, CoE, University of the Philippines - Diliman}
\multiauthor
